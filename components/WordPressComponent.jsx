...
const WordPressComponent = () => {
    ...
    useEffect(() => {
        setHostingStarterPrice(1500);
        setHostingStarterPriceInitial(7500);
        setHostingGrowthPrice(3500);
        setHostingGrowthPriceInitial(17500);
        setHostingProPrice(5500);
        setHostingProPriceInitial(27500);
        setHostingEnterprisePrice(8200);
        setHostingEnterprisePriceInitial(41000)
    ...
    const cycleChanged = (e) => {
        if (e.target.value === "monthly"){
            ...
            setHostingStarterPrice(4050);
            setHostingGrowthPrice(9450);
            setHostingProPrice(14850);
            setHostingEnterprisePrice(22140);
            setBillingCycle("quarter");
            setHostingStarterPriceInitial(Math.round(7500 * 3 * 100)/100);
            setHostingGrowthPriceInitial(Math.round(17500 * 3 * 100)/100);
            setHostingProPriceInitial(Math.round(27500 *3 * 100)/100);
            setHostingEnterprisePriceInitial(Math.round(41000 * 3 * 100)/100);
            setFreeDomain(false);
        }else if (e.target.value === "yearly"){
            setPercentReduced(85);
            setHostingStarterPrice(13500);
            setHostingGrowthPrice(31500);
            setHostingProPrice(59400);
            setHostingEnterprisePrice(73800);
            setBillingCycle("year");
            setHostingStarterPriceInitial(Math.round(7500 * 12 * 100)/100);
            setHostingGrowthPriceInitial(Math.round(17500 * 12 * 100)/100);
            setHostingProPriceInitial(Math.round(27500 * 12 * 100)/100);
            setHostingEnterprisePriceInitial(Math.round(41000 * 12 * 100)/100)
        }
    }

    const starterClicked = () => {
        setMainName('wp_starter');
        setMainBilling(billingCycle);
        setMainPrice(hostingStarterPrice);
    }

    const growthCLicked = () => {
        setMainName('wp_growth');
        setMainBilling(billingCycle);
        ...
        <form onSubmit={(e) => e.preventDefault()} className="h-max w-full">
            ...
            <div className="h-max w-full flex flex-col sm:flex-row px-3 justify-between items-center">
                <div className="card border w-full mb-5 sm:mb-0 rounded border-grey py-8 px-2 sm:w-[24%] h-max sm:h-[110vh] relative">
                    ...
                    <p className="text-accent text-sm mb-4">Personal blogs</p>
                ...
                <div className="card w-full mb-5 sm:mb-0 border rounded border-primary py-8 px-3 sm:w-[24%] h-max sm:h-[110vh] relative">
                    ...
                    <p className="text-accent text-sm mb-4">Small business sites</p>
                ...
                <div className="card w-full mb-5 sm:mb-0 border rounded border-grey py-8 px-3 sm:w-[24%] h-max sm:h-[110vh] relative">
                    ...
                    <p className="text-accent text-sm mb-4">High traffic sites</p>
                ...
                <div className="card w-full mb-5 sm:mb-0 border rounded border-grey py-8 px-3 sm:w-[24%] h-max sm:h-[110vh] relative">
                    <h2 className="text-2xl font-semibold text-accent mb-4">E-Commerce</h2>
                    <p className="text-accent text-sm mb-4">for e-commerce websites</p>
