...
const EmailComponent = () => {
    ...
    return ( 
        ...
        <form className="h-max w-full flex flex-col sm:flex-row px-3 justify-evenly items-center">
            <div className="card border w-full mb-5 sm:mb-0 rounded border-grey py-8 px-2 sm:w-[30%] h-[120vh] relative">
            ...
            <div className="card w-full mb-5 sm:mb-0 border rounded border-grey py-8 px-3 sm:w-[30%] h-[120vh] relative">
