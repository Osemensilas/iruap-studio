...
const WebHostingComponent = () => {
    ...
    return ( 
        ...
        <form className="h-max w-full flex flex-col sm:flex-row px-3 justify-between items-center">
          <div className="card border w-full mb-5 sm:mb-0 rounded border-grey py-8 px-2 sm:w-[24%] h-[80vh] relative">
          ...
          <div className="card w-full mb-5 sm:mb-0 border rounded border-grey py-8 px-3 sm:w-[24%] h-[80vh] relative">
          ...
          <div className="card w-full mb-5 sm:mb-0 border rounded border-grey py-8 px-3 sm:w-[24%] h-[80vh] relative">
            ...
            <p className="text-grey mb-4"><span className="line-through">$21.10</span> Save {percentReduced}%</p>
          ...
          <div className="card w-full mb-5 sm:mb-0 border rounded border-grey py-8 px-3 sm:w-[24%] h-[80vh] relative">
            ...
            <p className="text-grey mb-4"><span className="line-through">$30.83</span> Save {percentReduced}%</p>
            <h2 className="text-3xl text-accent text-semibold mb-4">${hostingEnterprisePrice}<span className="text-base">/month</span></h2>
            <div className="w-full h-max border-t border-grey pt-4">
              <p className="text-accent text-sm mb-1"><i className="fa fa-home text-accent mr-2"></i>1 Website</p>
              <p className="text-accent text-sm mb-1"><i className="fa fa-users text-accent mr-2"></i>10,000 Monthly Visitors</p>
              <p className="text-accent text-sm mb-1"><i className="fa fa-microchip text-accent mr-2"></i>1GB RAM</p>
