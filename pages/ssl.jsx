...
const SSL = () => {
    return ( 
        <>
        <Head>
            <title>SSL Certificate - IruHost</title>
        </Head>
        ...
        <section id="security" className="w-full bg-accent py-10 px-2 sm:px-10">
            <div className="flex flex-col-reverse md:flex-row items-center justify-center gap-10 mb-12">
                ...
                <div className="w-full md:w-1/2 flex justify-center">
                    <img src="ssl-cert.jpg" alt="ero-img" className="w-[320px] h-[320px] object-contain rounded"/>
                </div>
            </div>
