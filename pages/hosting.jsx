...
const Hosting = () => {
    return ( 
        <>
        <Head>
            <title>Shared Hosting - IruHost</title>
        </Head>
        <section id="hero" className="h-[calc(100vh-100px)] w-screen bg-background">
            <div className="h-full w-full flex flex-col justify-center items-center px-2 sm:px-20">
                ...
                <p className="text-accent text-base font-semibold mb-10">Get reliable hosting with free SSL, business email, and 99.9% uptime—starting at just ₦850/month</p>
        ...
        <div className="w-screen h-max py-[50px] sm:py-[100px] px-3 sm:px-10 text-accent">
            <h2 className="mb-10 text-center text-xl sm:text-3xl font-semibold text-text">Claim your FREE 1-year domain when you use our annual Enterprise hosting</h2>
