...
const Apps = () => {
    ...
    useEffect(() => {
        async function getUserProducts(){
            let url = "https://backend.iruhost.com/api/user-app";
    ...
    return ( 
        <>
        <Head>
            <title>User Web Applications - IruHost</title>
        </Head>
        <div className="h-max w-full px-2 sm:px-10 pt-10">
            <h2 className="text-2xl font-bold mb-10">Apps</h2>
            <div className="h-max w-full">
                <table className="h-max w-full text-xs sm:text-base">
                    <thead className="border-b border-grey w-full">
                        <tr className="w-full">
                            <th className="py-3 px-4 mb-3 text-left">Product</th>
                            <th className="py-3 px-4 mb-3 text-left">Type</th>
