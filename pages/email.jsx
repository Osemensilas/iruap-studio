...
const Email = () => {
    return ( 
        <>
        <Head>
            <title>Email Hosting - IruHost</title>
        </Head>
        ...
        <div className="w-screen h-max py-[50px] sm:py-[100px] px-3 sm:px-10 text-accent">
            <h2 className="mb-10 text-center text-xl sm:text-3xl text-text font-semibold">Ready to look professional?</h2>
        ...
        <section id="email-talk" className="w-full py-12 px-2 sm:px-10 bg-white">
            ...
            <div className="mb-12">
                ...
                <div className="bg-accent rounded cards-shadow p-6 flex flex-col items-center">
                    <img src="/trust.png" alt="" className="h-16 w-16 mb-4" />
                ...
                {/* Card 2 */}
                <div className="bg-accent rounded cards-shadow p-6 flex flex-col items-center">
                    <img src="/manage.png" alt="" className="h-16 w-16 mb-4" />
                ...
                {/* Card 3 */}
                <div className="bg-accent rounded cards-shadow p-6 flex flex-col items-center">
                    <img src="/control.png" alt="" className="h-16 w-16 mb-4" />
                ...
                {/* Card 4 */}
                <div className="bg-accent rounded cards-shadow p-6 flex flex-col items-center">
                    <img src="/productive.png" alt="" className="h-16 w-16 mb-4" />
                ...
                {/* Card 5 */}
                <div className="bg-accent rounded cards-shadow p-6 flex flex-col items-center">
                    <img src="/team.png" alt="" className="h-16 w-16 mb-4" />
                ...
                {/* Card 6 */}
                <div className="bg-accent rounded cards-shadow p-6 flex flex-col items-center">
                    <img src="/belonging.png" alt="" className="h-16 w-16 mb-4" />
            ...
            <div className="mb-12">
                ...
                {/* Continue Card 1 */}
                <div className="bg-accent rounded cards-shadow p-6 flex flex-col items-center">
                    <img src="/2fa.png" alt="" className="h-16 w-16 mb-4" />
                ...
                {/* Continue Card 2 */}
                <div className="bg-accent rounded cards-shadow p-6 flex flex-col items-center">
                    <img src="/protection.png" alt="" className="h-16 w-16 mb-4" />
                ...
                {/* Continue Card 3 */}
                <div className="bg-accent rounded cards-shadow p-6 flex flex-col items-center">
                    <img src="/spam.png" alt="" className="h-16 w-16 mb-4" />
                ...
                {/* Continue Card 4 */}
                <div className="bg-accent rounded cards-shadow p-6 flex flex-col items-center">
                    <img src="/brand-impact.png" alt="" className="h-16 w-16 mb-4" />
                ...
                {/* Continue Card 5 */}
                <div className="bg-accent rounded cards-shadow p-6 flex flex-col items-center">
                    <img src="/address.png" alt="" className="h-16 w-16 mb-4" />
                ...
                {/* Continue Card 6 */}
                <div className="bg-accent rounded cards-shadow p-6 flex flex-col items-center">
                    <img src="/role-model.png" alt="" className="h-16 w-16 mb-4" />
