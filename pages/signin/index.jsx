                ...
                <form action="/" className="w-4/5 h-max">
                    ...
                    <div className="w-full h-max mb-2.5">
                        <div className="w-full h-max mb-4">
                            ...
                            <input type="text" id="email" className="h-10 w-full border text-accent outline-none border-silver mb-1 rounded px-2 bg-transparent" />
                            <div className="text-danger"></div>
                        </div>
                        <div className="w-full h-max mb-4">
                            <label htmlFor="password" className="text-grey mb-4">Password:</label>
                            <input type="password" id="password" className="h-10 w-full border text-accent outline-none border-silver mb-1 rounded px-2 bg-transparent" />
                            <div className="text-danger"></div>
                        </div>
                        <div className="text-grey">
                            Don't have an account? <Link href="/signup" className="text-primary hover:underline transition duration-300 ease-in-out">Sign Up</Link>
                        </div>
                    </div>
                    <div className="h-max w-full py-2">
                        <button className="w-full py-2 bg-btns text-text rounded bg-primary">Sign In</button>
                    </div>
